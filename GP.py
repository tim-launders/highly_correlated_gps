# Defines functionality for the Gaussian process
...
class GaussianProcessRegressor(MultiOutputMixin, RegressorMixin, BaseEstimator):
    ...
    * exposes a method `log_marginal_likelihood(theta)`, which can be used
    ...
    def add_offdiag(self, y, total, norms, points):
        '''Add off-diagonal elements to the covariance matrix from covariance in measurements.
        ...
        cov_mat : array-like of shape(n_samples, n_samples)
            Covariance matrix for all measured data points to be added to the kernel. 
        '''
        num_sets = len(points)
        ...
        # Compute covariance matrix from experimental inputs
